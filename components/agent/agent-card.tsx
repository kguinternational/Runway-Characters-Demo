...
export function AgentCard() {
  ...
  return (
    <aside
      ...
      className={cn(
        "fixed z-50 overflow-hidden border border-white/10 bg-[#101514] text-white shadow-[-24px_0_100px_rgba(4,8,7,0.3)]",
        minimized
          ? "bottom-3 right-3 w-[220px] rounded-[1.6rem] sm:bottom-5 sm:right-5"
          : "inset-y-0 right-0 w-full rounded-none sm:w-[420px] sm:rounded-l-[1.75rem]",
      )}
    ...
    >
      ...
      <div
        className={minimized ? "hidden" : "h-[calc(100dvh-3.5rem)] overflow-y-auto"}
      >
        {active ? (
          <AvatarCall
          ...
          <div className="flex min-h-full flex-col justify-center p-6">
            ...
            <div className="mt-5 rounded-2xl border border-white/10 bg-white/[0.04] p-3.5">
              ...
              <p className="mt-2 text-xs leading-5 text-white/62">
                ...
                change revenue ranges, open panels, and create or update
                tickets.
              </p>
            </div>
            <div className="mt-5">
